...
#define EQUAL(v1, v2) (v1.x == v2.x && v1.y == v2.y && v1.z == v2.z) // inline
                                                                     // bool
                                                                     // operator==
                                                                     // (const
                                                                     // vec3&
                                                                     // V2)
                                                                     // const
#define PLUS(v1, v2) { v1.x + v2.x, v1.y + v2.y, v1.z + v2.z } // inline vec3
                                                               // operator+
                                                               // (const vec3&
                                                               // V2) const
                                                               // //XXX
                                                               ...
                                                               // of returning
                                                               // new vec3
#define SUB(v1, v2) { v1.x - v2.x, v1.y - v2.y, v1.z - v2.z } // inline vec3
                                                              // operator-
                                                              // (const vec3&
                                                              // V2) const //XXX
                                                              // different
                                                              ...
                                                              // of returning
                                                              // new vec3
#define SUBP(v1, arr) { v1.x - arr[0], v1.y - arr[1], v1.z - arr[2] } // inline
                                                                      // vec3
                                                                      // SubP(const
                                                                      // double
                                                                      // *v)
...
#define DIVK(v1, k) { v1.x = v1.x / k; v1.y = v1.y / k; v1.z = v1.z / k; } //
                                                                           // inline
                                                                           // vec3
                                                                           // operator/
                                                                           // (double
                                                                           ...
                                                                           // more
                                                                           // efficient
#define DIV(v1, v2) { v1.x / v2.x, v1.y / v2.y, v1.z / v2.z }  // inline vec3
                                                               // operator/
                                                               // (const vec3&
                                                               // V2) const
#define MUL(v1, v2) { v1.x *v2. x, v1.y *v2.y, v1.z *v2.z } // inline vec3
                                                            // operator* (const
                                                            // vec3& V2) const
#define MULK(v1, k) { v1.x *k, v1.y *k, v1.z *k }                          //
                                                                           // inline
                                                                           // vec3
                                                                           // operator*
                                                                           // (double
                                                                           // S)
                                                                           // const
#define ADD(v1, k) { v1.x = v1.x + k; v1.y = v1.y + k;  v1.z = v1.z + k; } //
                                                                           // inline
                                                                           // vec3
                                                                           // operator+
                                                                           // (double
                                                                           // S)
                                                                           // const
#define SUBK(v1, k) { v1.x - k, v1.y - k, v1.z - k }    // inline vec3 operator-
                                                        // (double S) const

// MODIFIES FIRST VECTOR
#define PLUSEQUAL(v1, v2) { v1.x = v1.x + v2.x; v1.y = v1.y + v2.y; v1.z = v1.z + \
                                                                           v2.z; } //
                                                                                   // inline
                                                                                   // void
                                                                                   // operator+=
                                                                                   ...
                                                                                   // V2
                                                                                   // )
#define SUBEQUAL(v1, v2) { v1.x = v1.x + v2.x; v1.y = v1.y + v2.y; v1.z = v1.z + \
                                                                          v2.z; }  //
                                                                                   // inline
                                                                                   // void
                                                                                   // operator-=
...
#define SUBDUBDUB(d1, d2) { d1[0] - d2[0], d1[1] - d2[1], d1[2] - d2[2] } //
                                                                          // inline
                                                                          // vec3
                                                                          // SubtractDoubleDouble(const
                                                                          // double
                                                                          // *d1,
                                                                          // const
                                                                          // double
